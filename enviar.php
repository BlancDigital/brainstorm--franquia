...
$emailatt_cliente = 'contato@escolabrainstorm.com.br';
...
$envio_cliente  = mail($emailatt_cliente,"[Lead] Brainstorm - Escoal de negócios", $corpoHTML, $header_cliente);
...
$envio_leads     = mail($emailatt_leads,"[Lead] Brainstorm - Escoal de negócios", $corpoHTML_leads, $header_leads); 
